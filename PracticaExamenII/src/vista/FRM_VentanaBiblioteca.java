...
public class FRM_VentanaBiblioteca extends javax.swing.JFrame {
   ...
   public FRM_VentanaBiblioteca() {
        initComponents();
       controlador = new Controlador_FRM_VentanaBiblioteca();
    ...
    {
        this.itemSalir.addActionListener(controlador);
        this.itemRegistrarLibro.addActionListener(controlador);
    }
    /**
    ...
    private void initComponents() {
        ...
        itemRegistrarLibro.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_L, java.awt.event.InputEvent.CTRL_MASK));
        itemRegistrarLibro.setText("Registrar Libro");
        jMenu2.add(itemRegistrarLibro);
